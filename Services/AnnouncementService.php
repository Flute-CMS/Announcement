...
class AnnouncementService
{
    ...
    public function format(Announcement $announcement): array
    {
        return [
            ...
            'buttonStyle' => $announcement->buttonStyle,
            'buttonNewTab' => $announcement->buttonNewTab,
            'secondaryButtonText' => $announcement->secondaryButtonText,
            'secondaryButtonUrl' => $announcement->secondaryButtonUrl,
            'secondaryButtonIcon' => $announcement->secondaryButtonIcon,
            'secondaryButtonStyle' => $announcement->secondaryButtonStyle,
            'secondaryButtonNewTab' => $announcement->secondaryButtonNewTab,
            'showTimer' => $announcement->showTimer,
            'timerAt' => $announcement->timerAt,
